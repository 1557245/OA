...
public interface NoticeMapper {
	...
	// 插入发布的公告
	void insertNotice(Integer n_eid, String title, String content, String recipinets, String publishtime, String annex,
	...
	// 查询接收的公告，顺便查询总数
	List<Notice> selectReceivedNotice(String ename, Integer selectStart1, Integer pageSize1);
